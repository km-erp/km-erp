...
// app
  {id: 'email', pl: 'email'},
  {id: 'forgotPwd', pl: 'Zapomniałem hasło'},
  ...
  {id: 'registerEmail', pl: 'Czy chcesz zarejestrować nowego użytkownika dla "{0}"? Jeżeli jeżeli chcesz potwierdzić to wpisz ponownie hasło. Po potwierdzeniu będzie możliwe zalogowanie się. Czy kontynuować?'},
